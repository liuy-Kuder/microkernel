#ifndef __MK_LIST_H__
#define __MK_LIST_H__
...
/*
#define list_first_entry_or_null(ptr, type, member) \
	ptr.next != (struct list_head *) ptr ? list_entry(ptr.next, type, member) : NULL \
*/
/**
...
*/
#define hlist_for_each_entry_safe(pos, type, n, head, member) \
	for (pos = hlist_entry_safe((head)->first, type, member); \
	     pos && (( n = pos->member.next ) || 1); \
