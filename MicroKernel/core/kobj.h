...
struct kobj_t
{
	...
	/* kobj read */
	size_t (*read)(struct kobj_t * kobj, size_t offset, void * buf, size_t size);
	/* kobj write */
	size_t (*write)(struct kobj_t * kobj, size_t offset, void * buf, size_t size);
	/* kobj ioctl */
...
typedef size_t (*kobj_read_t)(struct kobj_t * kobj, size_t offset, void * buf, size_t size);
typedef size_t (*kobj_write_t)(struct kobj_t * kobj, size_t offset, void * buf, size_t size);
...
uint8_t kobj_add_regular(struct kobj_t * parent, const char * name, kobj_read_t read, kobj_write_t write, kobj_ioctl_t ioctl,size_t size, void * priv);
